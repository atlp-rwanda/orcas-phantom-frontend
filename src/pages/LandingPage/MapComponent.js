...
const MapComponent = () => {
  ...
  if(state.sampleLocation.length > 0) L.marker(state.sampleLocation).addTo(map);
  ...
  return (
    <div data-testid="map-component">
      <MapContainer
        ...
        center={state.sampleLocation.length === 0 ? [-1.9440138579421542, 30.061919689178463] : state.sampleLocation}
        zoom={state.sampleLocation.length === 0 ? 12 : 15}
        whenCreated={setMap}
      >
        <TileLayer
